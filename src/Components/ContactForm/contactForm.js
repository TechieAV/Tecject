      ...
      {timeSlots.map((slot, index) => (
        <button
          ...
          style={{
            padding: '0.5rem 1rem',
            borderRadius: '8px',
            border: selectedSlot === slot ? '2px solid #8a2be2' : '1px solid #444',
            background: selectedSlot === slot ? '#4b0082' : '#1a1a2e',
            color: 'white',
            cursor: 'pointer',
          }}
        >
          ...
          <TextArea
            ...
            required
          />
          <small style={{ textAlign: 'right', color: '#aaa' }}>{form.message.length}/300</small>
